...
object Catalog {
    ...
    val ALL: List<Point> = listOf(
        ...
        Point(Signals.CLOUD_KERNEL, Category.EMULATOR, "宿主 Linux 内核串 (Ubuntu/generic)"),
        Point(Signals.CLOUD_DISK, Category.EMULATOR, "虚拟磁盘 (vda/sr0, 无 mmcblk)"),
        Point(Signals.CLOUD_PCI, Category.EMULATOR, "PCI 总线 (手机无)"),
        Point(Signals.CLOUD_INPUT, Category.EMULATOR, "虚拟输入设备 (QEMU/Virtual)"),
        Point(Signals.CLOUD_CGROUP, Category.EMULATOR, "容器 cgroup (systemd/docker)"),
        Point(Signals.CLOUD_NET, Category.EMULATOR, "网卡只有 eth0 (无 wlan/蜂窝)"),
